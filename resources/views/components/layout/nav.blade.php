<nav class="hidden md:block h-5vh  bg-gray-100 flex flex-row  flex-wrap overflow-auto
justify-start mx-3 my-1  ">
    ...
    <a class="h-full btn btn-warning" href="{{route('alumnos')}}">Alumnos</a>
...
<nav class="block md:hidden flex flex-col justify-center" >
    ...
    <a class=" btn w-full hover:bg-blue-300 hover:text-white transition duration-300" href="{{route('alumnos')}}">Alumnos</a>
